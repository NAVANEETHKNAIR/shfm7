...
<html lang="en">
 ...
 <li>
    ...
    <input type="text" name="item_name" height="15" >
   
    
    <input type="image" src="assets/img/search.png" alt="search" width="40" height="40" >
    <input type="hidden" name="act" value="register">
    </form>-->
    <a href="search.php"><img src="images/search.png" title="search" width="40" height="40">
    </a>
    </li>
...
if($photo == NULL)
							...
							echo "<br>";
							echo '</div>';
							echo '</div>';echo '<img src="assets/img/line.jpg " width="1500000" height="20"  />';
