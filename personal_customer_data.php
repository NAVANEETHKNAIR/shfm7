      ...
      while($row=mysql_fetch_array($sqll))
      {
        ...
        echo "<br>";
                      ...
                      if($photo == NULL)
                               {
                                   ...
                                   echo "<a href=upload_customer_photo.html?id=$id><h4>Upload Photo </h4>";
                                   echo "<br>";
                ...
                else
                {
                  ...
                  echo "<a href=upload_customer_photo.html?id=$id><h4> Change Photo </h4>";
                                   echo "<br>";

                                   echo "<img src= '".$row['photo']."' class='img_circle' >";
                                          echo "</img>";
                    echo "<br>";
                      echo "</a>"; 
                }
        ...
        echo '<div class="name" >';
        echo "Name &nbsp &nbsp &nbsp &nbsp    :&nbsp &nbsp &nbsp &nbsp" .$name. "&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp  ";
        echo "<br>";
         echo '</div>';
         echo '<div class="address" >';
        echo "Address &nbsp &nbsp&nbsp  :&nbsp &nbsp &nbsp &nbsp &nbsp<div class='address_value' >".$address.  "</div>&nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp     <a href=edit_customer.php?id=$id><div class='edit' > <input type='image' src='images/edit.png' alt='Edit' width='35' height='35'></div></a>";
        echo "<br>";
         echo '</div>';
         echo '<div class="mob" >';
        echo "Mob no&nbsp &nbsp &nbsp &nbsp :&nbsp &nbsp &nbsp &nbsp ".$mob."&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp ";
        echo "<br>";
         echo '</div>';
         echo '<div class="pass" ><h4>';
        echo "<a href=change_password_customer.php?id=$id>Change Password </h4></a>";
        echo "<br>";
        echo "</center>";
        echo '</div>';
