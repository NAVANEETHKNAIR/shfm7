...
<marquee><font  color="green"><b> <blink>News Creation... News Creation... News Creation... News Creation...            News Creation... </blink></b></font></marquee>     
<p><br><br><br>
 <input type="text" name="topic" placeholder="Topic" autocomplete="off" required></br><br>
<input type="text" name= "date"id="datepicker" placeholder="Date" autocomplete="off" required></br><br>
			...
			if(isset($_POST["submit"])) 
			{
				...
				else
				{
			    	...
			    	{	
					    ...
					    $stt_date=date('Y-m-d', strtotime($st_date)); 
					    ...
					    //echo "hiiiiiii";
				  		while($row=mysql_fetch_array($sql))
				  		{
						    ...
						    $qrys = "INSERT INTO news(topic,st_date,file,uid)VALUES ('".$topic."','".$stt_date."','".$target_article_file."','".$id."')  ";
						    //echo $qrys;
	//echo $qrys;			
							$s=mysql_query($qrys);
							if($s)
					    	{
								...
								echo 'window.alert("You are Successfully Added News...");';
				        	...
				        	{	
								...
								echo 'document.location.href="create_news.php"';
								echo '</script>';
